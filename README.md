...
| [digest](digest/) | セッション履歴から繰り返しているプロンプトパターンを検出し、スキル/ルール/CLAUDE.md化の候補を提案する |
| [secret-guard](secret-guard/) | APIキー等のシークレットがAIのツール実行経由で流出するのを検知・ブロックするPreToolUseフックと、そのセットアップ用スキル |
